...
CREATE TABLE IF NOT EXISTS `candidatos` (
  ...
  `nombre_candidato` text CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `medios` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `medio` varchar(200) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `medios` (`id`, `medio`) VALUES
(1, 'Web'),
(2, 'TV'),
(3, 'Redes Sociales'),
(4, 'Amigo');
...
--
-- Estructura de tabla para la tabla `votaciones_medios`
--

DROP TABLE IF EXISTS `votaciones_medios`;
CREATE TABLE IF NOT EXISTS `votaciones_medios` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
